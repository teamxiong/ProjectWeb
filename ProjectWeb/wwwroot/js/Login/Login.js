...
function Click_Login()
{
    ...
    layer.load(2);
    $.ajax({
        url: "/Account/Click_Login",
        type: "POST",
        data: { logname: logname, logpass: logpass, valiCode: vcode},
...
function refreshvaliCode() {
    var id = document.getElementById("valiCode");
    var str = "/account/MixVerifyCode?random=" + Math.random();
