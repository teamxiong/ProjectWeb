...
namespace ProjectWebDataAccess
{
    ...
    public abstract class SqlHelper
    {
        ...
        {
            string connStr = Common.Serverlink("connectionString");
            return connStr;
        }
        ...
        public static List<Dictionary<string, string>> ConvertToDictionary(DataTable table)
        {
            ...
            foreach (DataRow row in table.Rows)
            {
                ...
                {
                    dict.Add(table.Columns[i].ColumnName, row[i].ToString());
                }
                list.Add(dict);
            }
            return list;
